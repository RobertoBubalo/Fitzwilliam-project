...
public class MyRect {
    ...
    // constructor with no arguments and using setters instead initializing the variable locally, although I have gotten the
    // advice I should not be doing that with explanation it can produce errors due to object of a class is stilling being made
    // and some methods might not be as swiftly made as needed - additional information prefered and happily received :)
    public MyRect() {
